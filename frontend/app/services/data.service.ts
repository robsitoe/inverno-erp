...
export class DataService {
    ...
    getSalesCampaigns(companyId?: string): Observable<SalesCampaign[]> {


        if (this.isLocalBrowser()) {


            const stored = localStorage.getItem('erp_sales_campaigns');
            ...
            if (companyId) {
                ...
                return of(campaigns.filter((c: any) => c.companyId === companyId));
            ...
            return this.http.get<SalesCampaign[]>(`${this.baseUrl}/sales/campaigns?companyId=${companyId || ''}`);
    ...
    getBestDiscount(articleId: string, familyId: string, companyId?: string): Observable<{ discount: number, campaignId?: string, name?: string }> {
        ...
        if (this.isLocalBrowser()) {
            ...
            return this.http.get<{ discount: number, campaignId?: string, name?: string }>(


                `${this.baseUrl}/sales/campaigns/best-discount?articleId=${articleId}&familyId=${familyId}&companyId=${cid}`
    ...
    createSalesCampaign(campaign: Partial<SalesCampaign>, companyId?: string): Observable<SalesCampaign> {
        ...
        if (this.isLocalBrowser()) {
            ...
            const newCampaign = { ...campaign, id: `CAMP-${Date.now()}`, companyId: companyId || this.activeCompanySubject.value?.id } as SalesCampaign;


            campaigns.push(newCampaign);


            localStorage.setItem('erp_sales_campaigns', JSON.stringify(campaigns));
            ...
            return this.http.post<SalesCampaign>(`${this.baseUrl}/sales/campaigns?companyId=${companyId || ''}`, campaign);
    ...
    updateSalesCampaign(id: string, campaign: Partial<SalesCampaign>, companyId?: string): Observable<SalesCampaign> {
        ...
        if (this.isLocalBrowser()) {
            ...
            return this.http.patch<SalesCampaign>(`${this.baseUrl}/sales/campaigns/${id}?companyId=${companyId || ''}`, campaign);
    ...
    deleteSalesCampaign(id: string, companyId?: string): Observable<any> {
        ...
        if (this.isLocalBrowser()) {
            ...
            localStorage.setItem('erp_sales_campaigns', JSON.stringify(filtered));
            ...
            return this.http.delete(`${this.baseUrl}/sales/campaigns/${id}?companyId=${companyId || ''}`);
    ...
    // --- Mobile Admin & Route Planning ---

    getPendingMobileDeliveries(): Observable<any[]> {
        return this.http.get<any[]>(`${this.baseUrl}/mobile/driver/pending-deliveries`);
    }

    getApprovedDrivers(): Observable<any[]> {
        return this.http.get<any[]>(`${this.baseUrl}/mobile/admin/drivers`);
    }

    assignMobileRoute(employeeId: string, docIds: string[]): Observable<any> {
        return this.http.post(`${this.baseUrl}/mobile/admin/assign-route`, { employeeId, docIds });
    }
