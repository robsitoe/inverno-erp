...
@Component({
  ...
  template: `
    ...
    <!-- Delivery Planning -->
    <ng-container *ngIf="activeView === 'delivery-planning'">
      <app-delivery-planning class="w-full h-full block"></app-delivery-planning>
    </ng-container>

    <!-- Vehicle Load & Unload -->
    <ng-container *ngIf="activeView === 'vehicle-load'">
      <app-vehicle-load-form class="w-full h-full block"></app-vehicle-load-form>
    </ng-container>

    <!-- Fleet Tracking Map -->
    <ng-container *ngIf="activeView === 'fleet-map'">
      <app-fleet-map class="w-full h-full block"></app-fleet-map>
    </ng-container>
    ...
    <!-- GESt - GAS Movement -->
    <ng-container *ngIf="activeView === 'gas-movement'">
      <app-gas-control activeTab="MOVEMENT" class="w-full h-full block"></app-gas-control>
    </ng-container>

    <!-- GESt - GAS Inventory -->
    <ng-container *ngIf="activeView === 'gas-inventory'">
      <app-gas-control activeTab="INVENTORY" class="w-full h-full block"></app-gas-control>
    </ng-container>
    ...
    <!-- Mobile Approvals -->
    <ng-container *ngIf="activeView === 'mobile-approvals'">
      <app-mobile-approvals class="w-full h-full block"></app-mobile-approvals>
    </ng-container>
        ...
        <div class="relative z-10 flex flex-col items-center justify-center h-full text-gray-800 p-8">
          <div class="bg-white/80 p-8 rounded-2xl shadow-xl backdrop-blur-md max-w-2xl w-full text-center border border-white/50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
              <div *ngIf="licenseService.hasFeature('SALES')" 
                   class="p-4 bg-blue-50 rounded-xl border border-blue-100 hover:shadow-md transition-shadow cursor-pointer group"
                   (click)="activeView = 'sales-form'">
              ...
              <div *ngIf="licenseService.hasFeature('ACCOUNTING')" 
                   class="p-4 bg-green-50 rounded-xl border border-green-100 hover:shadow-md transition-shadow cursor-pointer group"
                   (click)="activeView = 'chart-of-accounts'">
                <div class="flex items-center gap-3 mb-2">
              ...
              <div *ngIf="licenseService.hasFeature('INVENTORY')" 
                   class="p-4 bg-purple-50 rounded-xl border border-purple-100 hover:shadow-md transition-shadow cursor-pointer group"
                   (click)="activeView = 'article-management'">
                <div class="flex items-center gap-3 mb-2">
