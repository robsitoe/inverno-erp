            ...
            <div class="border border-gray-300 rounded-lg p-4">
              ...
              <div class="space-y-3">
                ...
                <div *ngIf="selectedType.accountingIntegration">
                  ...
                  <input [(ngModel)]="selectedType.defaultDebitAccount" type="text" class="w-full px-2 py-1.5 border border-gray-300 rounded text-xs focus:outline-none focus:border-purple-500" placeholder="Ex: 2.1.1">
                ...
                <div *ngIf="selectedType.accountingIntegration">
                  ...
                  <input [(ngModel)]="selectedType.defaultCreditAccount" type="text" class="w-full px-2 py-1.5 border border-gray-300 rounded text-xs focus:outline-none focus:border-purple-500" placeholder="Ex: 4.2.1">
  ...
  getDefaultDocumentTypes(): StockDocumentType[] {
    ...
    return [

      {
        ...
        defaultDebitAccount: '2.1.1',

        defaultCreditAccount: '4.2.1',
...

      {
        ...
        defaultDebitAccount: '6.1.1.2',

        defaultCreditAccount: '2.1.1',
