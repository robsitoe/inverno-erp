                                    ...
                                    <table class="w-full text-xs">
                                        ...
                                        <tbody>
                                            ...
                                            <tr *ngFor="let line of entry.lines" class="border-b">
                                                ...
                                                <td class="px-2 py-1 text-right font-mono">{{ (+line.debit || 0) | number:'1.2-2' }}</td>


                                                <td class="px-2 py-1 text-right font-mono">{{ (+line.credit || 0) | number:'1.2-2' }}</td>
...
export class JournalEntriesReviewComponent implements OnInit {
    ...
    getTotalDebit(entry: JournalEntry): number {
        ...
        return entry.lines.reduce((sum, line) => sum + (parseFloat(String(line.debit)) || 0), 0);
    ...
    getTotalCredit(entry: JournalEntry): number {
        ...
        return entry.lines.reduce((sum, line) => sum + (parseFloat(String(line.credit)) || 0), 0);
